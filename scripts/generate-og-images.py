...
THEMES = {
    "dark": dict(bg="#14161c", text="#ece7de", accent="#a855f7", out="assets/og-image-dark.png"),
    "light": dict(bg="#f6f3ec", text="#1d1a17", accent="#6d28d9", out="assets/og-image-light.png"),
}
